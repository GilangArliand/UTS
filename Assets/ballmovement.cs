...
public class ballmovement : MonoBehaviour
{
    ...
    sesuatu.velocity = new Vector2 (-1,-1)*speed;//Jika P1 mencetak score maka bola dimulai ke arah P1
    animtr.SetBool("IsMove",true);
    ...
    yield return new WaitForSeconds(1);
    sesuatu.velocity = new Vector2 (1,1)*speed; //Jika P2 mencetak score maka bola dimulai ke arah P2
    animtr.SetBool("IsMove",true);
